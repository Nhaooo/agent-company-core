...
| Secret scan | PASS | Gitleaks v8.30.1 reports 0 findings in the publication tree and 0 findings across all 5 Git commits; the first tree scan's 200 alerts were confined to the ignored local `.venv` license index and were removed as generated false positives |
...
- Full-history scan: PASS, 0 findings across all 5 commits in this new
  repository.
